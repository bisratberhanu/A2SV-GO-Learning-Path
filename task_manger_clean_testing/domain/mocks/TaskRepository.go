...
func (_m *TaskRepository) AddTask(c context.Context, newTask domain.Task) error {
...
func (_m *TaskRepository) DeleteById(c context.Context, id string) (int64, error) {
	ret := _m.Called(c, id)
...
func (_m *TaskRepository) GetTasksById(c context.Context, id string) (*domain.Task, error) {
	ret := _m.Called(c, id)
...
func (_m *TaskRepository) UpdateTask(c context.Context, id string, updatedTask domain.Task) error {
